...
let journals = [];
  ...
  // v0.16: renderRecentActivity moved to public/lib/cockpit-activity.js (window.__cockpitActivity).
  ...
  function bindSettingsForm(content) {
    ...
    const activityHtml = await window.__cockpitActivity.renderRecentActivity();
